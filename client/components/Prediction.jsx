...
const Prediction = ({predictions, isLoading}) => {    
    ...
    {
        return (
            <section className="p-8 sm:w-full bg-gray-800 rounded-xl shadow-lg flex flex-col justify-center items-center gap-4 xl:h-[70vh]">              
        ...
        return (            
            <section className="p-8 sm:w-full bg-gray-800 rounded-xl shadow-lg flex flex-col justify-center items-center gap-4 h-[70vh]">              
                <Bar 
                    data = {data}
                    options= {{
                        scales: {
